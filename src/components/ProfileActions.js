...
export default function ProfileActions({ targetId, relation = null, signedIn = false }) {
    ...
    return (
        <div className="profile-actions">
            ...
            <button type="button" className="pill" disabled title="Player trading is coming soon">🔄 Propose trade (soon)</button>
