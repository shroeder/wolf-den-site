    ...
    return (
        <div className={`cm ${panelFont.className}`}>
            ...
            <style jsx global>{`
                ...
                /* ⚠️ NO ROOT PREFIX — THE BLOCK ALREADY ADDS ONE. Written as ".cm .cf-card" this is served
                   as ".cm .cm .cf-card", which asks for two nested elements with that class; there is one, so
