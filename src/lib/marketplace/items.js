...
export const ITEMS = [
    ...
    //
    // ⚠️ AND ONLY FIVE PIECES IN EACH TIER CARRY ONE, which is the knob that keeps this affordable. The drop
    // rates were just solved to Luke's target — five celestial items a month across the Den and one
    // primordial — and at $10 and $20 on EVERY piece that is $840 a year at the till, against the $822 of
    // store credit the Den has bought in its entire history. Frequency and payout are separate knobs and
    // they have to be turned separately: the tiers land at the cadence he asked for, and a real-world reward
    // stays a rare thing WITHIN them. Five and five puts it at about one reward a month and $146 a year.
    //
