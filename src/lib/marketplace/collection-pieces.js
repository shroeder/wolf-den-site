...
export const COLLECTION_PIECES = [
    ...
    { id: "wg_blade", set: "wheelwarden", name: "Fanged Saber", rarity: "rare", icon: "GiCrescentBlade", flavor: "A lucky pull with a keen edge.", source: "wheel_bonus", sort: 971 },
    ...
    { id: "fd_tongs", set: "founder", name: "Long Crucible Tongs", rarity: "epic", icon: "GiPincers", flavor: "Long enough to keep your eyebrows.", depth: { crucible: 5 }, source: "mining", sort: 989 },
