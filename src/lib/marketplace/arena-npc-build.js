...
const BUILDS = {
    ...
    rv_exsang: { cls: "reaver", shape: "berserker", pet: "dragon_whelp", weight: 0.87,
    ...
    rv_scent: { cls: "reaver", shape: "berserker", pet: "elder_dragon", weight: 0.81,
    ...
    rv_guillotine: { cls: "reaver", shape: "duelist", pet: "chameleon", weight: 0.85,
    ...
    rv_harvest: { cls: "reaver", shape: "brute", pet: "gorilla", weight: 1.01,
    ...
    rv_riposte: { cls: "reaver", shape: "wall", pet: "lion_cub", weight: 0.73,
    ...
    rv_concuss: { cls: "reaver", shape: "brute", pet: "griffin", weight: 0.81,
    ...
    rv_laststand: { cls: "reaver", shape: "wall", pet: "bear_cub", weight: 0.73,
    ...
    rv_butcher: { cls: "reaver", shape: "duelist", pet: "baby_rex", weight: 0.90,
    ...
    rv_balanced: { cls: "reaver", shape: "balanced", pet: "tiger_cub", weight: 0.77,
    ...
    wd_thorns: { cls: "warden", shape: "wall", pet: "gorilla", weight: 0.91,
    ...
    wd_ledger: { cls: "warden", shape: "brute", pet: "griffin", weight: 0.61,
    ...
    wd_unbreak: { cls: "warden", shape: "wall", pet: "bear_cub", weight: 1.21,
    ...
    wd_concuss: { cls: "warden", shape: "duelist", pet: "eagle", weight: 0.69,
    ...
    wd_medic: { cls: "warden", shape: "wall", pet: "wolf_pup", weight: 1.09,
    ...
    wd_reprisal: { cls: "warden", shape: "balanced", pet: "tiger_cub", weight: 1.06,
    ...
    wd_resolve: { cls: "warden", shape: "berserker", pet: "hydra", weight: 1.00,
    ...
    rc_frostbite: { cls: "runecaller", shape: "wall", pet: "elder_dragon", weight: 0.81,
    ...
    rc_pyre: { cls: "runecaller", shape: "brute", pet: "griffin", weight: 1.13,
    ...
    rc_emberdrink: { cls: "runecaller", shape: "berserker", pet: "dragon_whelp", weight: 0.79,
    ...
    rc_surge: { cls: "runecaller", shape: "balanced", pet: "hydra", weight: 0.80,
    ...
    rc_soulfire: { cls: "runecaller", shape: "duelist", pet: "baby_rex", weight: 1.17,
    ...
    rc_ward: { cls: "runecaller", shape: "wall", pet: "gorilla", weight: 1.03,
    ...
    rc_shatter: { cls: "runecaller", shape: "brute", pet: "croc", weight: 1.28,
    ...
    rc_cataclysm: { cls: "runecaller", shape: "berserker", pet: "runebound_drake", weight: 1.28,
    ...
    rc_chill: { cls: "runecaller", shape: "duelist", pet: "chameleon", weight: 1.07,
    ...
    rc_balanced: { cls: "runecaller", shape: "balanced", pet: "eagle", weight: 0.75,
