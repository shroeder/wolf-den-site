...
export const POOL = {
    ...
    hoot: { id: "hoot", pet: "owl", name: "Hoot", cost: 1, kind: "skill", target: "self", tier: 1,
        draw: 2, text: "Draw {draw} card{s:draw}.",
        upgrade: { draw: 3 } },
    ...
    fetch: { id: "fetch", pet: "raccoon", name: "Fetch", cost: 0, kind: "skill", target: "self", tier: 2,
        energy: 1, draw: 1, text: "Gain {energy} energy. Draw {draw} card{s:draw}.",
        upgrade: { draw: 2 } },
    ...
    rummage: { id: "rummage", pet: "monkey", name: "Rummage", cost: 1, kind: "attack", target: "foe", tier: 1,
        damage: 9, draw: 1, text: "Deal {damage} damage. Draw {draw} card{s:draw}.",
    ...
    trance: { id: "trance", pet: "parrot", name: "Battle Trance", cost: 0, kind: "skill", target: "self", tier: 3,
        draw: 3, exhaust: true, text: "Draw {draw} card{s:draw}. Exhaust.",
        upgrade: { draw: 4 } },
    ...
    bloodletting: { id: "bloodletting", pet: "anglerfish", name: "Bloodletting", cost: 0, kind: "skill", target: "self", tier: 1,
        selfHp: 3, energy: 2, exhaust: true, text: "Lose {selfHp} health. Gain {energy} energy. Exhaust.",
        upgrade: { energy: 3 } },

    // ── TIER 2 ──
    metallicize: { id: "metallicize", pet: "anvil_golem", name: "Metallicize", cost: 1, kind: "power", target: "self", tier: 2,
        blockEach: 3, text: "Gain {blockEach} Block at the end of every turn.",
        upgrade: { blockEach: 4 } },
    heavyblade: { id: "heavyblade", pet: "marlin", name: "Heavy Blade", cost: 2, kind: "attack", target: "foe", tier: 2,
        damage: 14, strengthMult: 3, text: "Deal {damage} damage. Strength counts {strengthMult} times.",
        upgrade: { strengthMult: 5 } },
    disarm: { id: "disarm", pet: "bee", name: "Disarm", cost: 1, kind: "skill", target: "foe", tier: 2,
        foeStrength: 2, exhaust: true, text: "The enemy loses {foeStrength} Strength for good. Exhaust.",
    ...
    flamebarrier: { id: "flamebarrier", pet: "cinder_hound", name: "Flame Barrier", cost: 2, kind: "skill", target: "self", tier: 2,
        block: 12, thorns: 4, text: "Gain {block} Block. Deal {thorns} damage back to anything that hits you.",
    ...
    demonform: { id: "demonform", pet: "ember_whelp", name: "Demon Form", cost: 3, kind: "power", target: "self", tier: 3,
        strengthEach: 2, text: "Gain {strengthEach} Strength at the start of every turn.",
    ...
    berserk: { id: "berserk", pet: "corsair_parrot", name: "Berserk", cost: 2, kind: "power", target: "self", tier: 3,
        energyEach: 1, selfHp: 6, text: "Lose {selfHp} health. Gain 1 energy every turn.",
        upgrade: { selfHp: 3 } },

    // -- AND ONE FOR EVERY REMAINING ANIMAL IN THE DEN --------------------------------------------------
    // Luke's rule: "there should always be a card for each pet. no two cards have the same effect." Both
    // halves matter and the second is the harder one -- two cards with one effect is ONE card and a wasted
    // pet, which is the whole promise of a deck made of your collection broken quietly. Swarm and Flock
    // were exactly that: same cost, same damage, same number of hits, a different bird on the front.
    //
    // WARNING: RARITY SKEWS THE TIER, IT DOES NOT GATE THE CEILING. The Den's legendary-and-above pets have
    // a MEDIAN OF ZERO owners and the median member owns eight animals in total, so a rule that put the
    // strong cards behind rare pets would hand almost every member a game with no top end at all. The cards
    // that decide whether a deck can SCALE already sit on animals people own (see the note above Demon
    // Form); what rarity buys here is reach and flavour -- a Mammoth hits harder than a Chick, and a Chick
    // still has a card of its own.
    chick: { id: "chick", pet: "chick", name: "Peep", cost: 0, kind: "attack", target: "foe", tier: 1,
        damage: 2, draw: 1, text: "Deal {damage} damage. Draw 1 card.",
        upgrade: { damage: 4 } },
    tropical_fish: { id: "tropical_fish", pet: "tropical_fish", name: "Shoal", cost: 1, kind: "attack", target: "foe", tier: 1,
        damage: 2, hits: 3, text: "Deal {damage} damage three times.",
        upgrade: { damage: 3 } },
    ...
    powder_monkey: { id: "powder_monkey", pet: "powder_monkey", name: "Powder Run", cost: 0, kind: "skill", target: "self", tier: 2,
        energy: 1, exhaust: true, text: "Gain {energy} energy. Exhaust.",
        upgrade: { energy: 2 } },
    vulture: { id: "vulture", pet: "vulture", name: "Circling", cost: 1, kind: "attack", target: "foe", tier: 1,
        damage: 5, vulnerable: 2, text: "Deal {damage} damage. Apply {vulnerable} Vulnerable.",
        upgrade: { damage: 7, vulnerable: 3 } },
    spring_lamb: { id: "spring_lamb", pet: "spring_lamb", name: "Soft-Footed", cost: 1, kind: "skill", target: "self", tier: 1,
        block: 7, weak: 1, text: "Gain {block} Block. Apply {weak} Weak.",
        upgrade: { block: 10 } },
    field_mouse: { id: "field_mouse", pet: "field_mouse", name: "Gleaning", cost: 1, kind: "skill", target: "self", tier: 1,
        block: 3, draw: 2, text: "Gain {block} Block. Draw 2 cards.",
        upgrade: { block: 6 } },
    copper_paw: { id: "copper_paw", pet: "copper_paw", name: "Change Tray", cost: 0, kind: "skill", target: "self", tier: 1,
        block: 2, draw: 1, text: "Gain {block} Block. Draw 1 card.",
        upgrade: { block: 4 } },
    reef_seahorse: { id: "reef_seahorse", pet: "reef_seahorse", name: "Curl Up", cost: 1, kind: "skill", target: "self", tier: 2,
        block: 9, text: "Gain {block} Block.",
        upgrade: { block: 13 } },
    pantry_mouse: { id: "pantry_mouse", pet: "pantry_mouse", name: "Pilfer", cost: 0, kind: "attack", target: "foe", tier: 1,
        damage: 4, draw: 1, text: "Deal {damage} damage. Draw 1 card.",
        upgrade: { damage: 6 } },
    ...
    toucan: { id: "toucan", pet: "toucan", name: "Raucous Call", cost: 0, kind: "skill", target: "foe", tier: 2,
        ...
        upgrade: { weak: 2 } },
    jellyfish: { id: "jellyfish", pet: "jellyfish", name: "Sting Cloud", cost: 1, kind: "attack", target: "foe", tier: 2,
        damage: 3, all: true, weak: 1, text: "Deal {damage} damage to ALL enemies. Apply {weak} Weak.",
        upgrade: { damage: 5 } },
    cinder_scarab: { id: "cinder_scarab", pet: "cinder_scarab", name: "Fan the Coals", cost: 2, kind: "power", target: "self", tier: 2,
        strength: 2, block: 6, text: "Gain {strength} Strength and {block} Block.",
        upgrade: { strength: 3, block: 9 } },
    geode_sprite: { id: "geode_sprite", pet: "geode_sprite", name: "Chime", cost: 0, kind: "skill", target: "self", tier: 2,
        draw: 2, exhaust: true, text: "Draw {draw} card{s:draw}. Exhaust.",
        upgrade: { draw: 3 } },
    tallyman: { id: "tallyman", pet: "tallyman", name: "The Count", cost: 1, kind: "attack", target: "foe", tier: 2,
        damage: 4, hits: 2, draw: 1, text: "Deal {damage} damage twice. Draw 1 card.",
        upgrade: { damage: 6 } },
    house_ferret: { id: "house_ferret", pet: "house_ferret", name: "Floorboard", cost: 0, kind: "attack", target: "foe", tier: 2,
        damage: 5, exhaust: true, text: "Deal {damage} damage. Exhaust.",
        upgrade: { damage: 8 } },
    lantern_jelly: { id: "lantern_jelly", pet: "lantern_jelly", name: "Soft Glow", cost: 1, kind: "skill", target: "self", tier: 2,
        heal: 6, block: 6, text: "Heal {heal}. Gain {block} Block.",
        upgrade: { heal: 9, block: 9 } },
    copper_kettle: { id: "copper_kettle", pet: "copper_kettle", name: "Boil Over", cost: 2, kind: "attack", target: "foe", tier: 2,
        damage: 10, thorns: 3, text: "Deal {damage} damage. Deal {thorns} damage back to anything that hits you.",
        upgrade: { damage: 13, thorns: 5 } },
    hearth_cat: { id: "hearth_cat", pet: "hearth_cat", name: "By the Fire", cost: 1, kind: "skill", target: "self", tier: 2,
        heal: 10, exhaust: true, text: "Heal {heal}. Exhaust.",
        upgrade: { heal: 15 } },
    hydra: { id: "hydra", pet: "hydra", name: "Two Grow Back", cost: 2, kind: "attack", target: "foe", tier: 3,
        damage: 7, hits: 3, text: "Deal {damage} damage three times.",
        upgrade: { damage: 9 } },
    ...
    baby_rex: { id: "baby_rex", pet: "baby_rex", name: "Apex", cost: 2, kind: "attack", target: "foe", tier: 3,
        ...
        upgrade: { damage: 28 } },
    forgeheart_wyrm: { id: "forgeheart_wyrm", pet: "forgeheart_wyrm", name: "Forge Heart", cost: 2, kind: "power", target: "self", tier: 3,
        strength: 3, block: 8, text: "Gain {strength} Strength and {block} Block.",
        upgrade: { strength: 4, block: 12 } },
    octopus: { id: "octopus", pet: "octopus", name: "Eight Arms", cost: 2, kind: "attack", target: "foe", tier: 3,
        damage: 4, hits: 5, text: "Deal {damage} damage five times.",
        upgrade: { damage: 5 } },
    polar_bear: { id: "polar_bear", pet: "polar_bear", name: "Cold Weight", cost: 3, kind: "attack", target: "foe", tier: 3,
        damage: 18, all: true, text: "Deal {damage} damage to ALL enemies.",
        upgrade: { damage: 24 } },
    mammoth: { id: "mammoth", pet: "mammoth", name: "Immense", cost: 3, kind: "skill", target: "self", tier: 3,
        block: 24, strength: 2, text: "Gain {block} Block and {strength} Strength.",
        upgrade: { block: 32, strength: 3 } },
    sea_serpent: { id: "sea_serpent", pet: "sea_serpent", name: "Terror of the Deep", cost: 2, kind: "attack", target: "foe", tier: 3,
        damage: 16, weak: 2, vulnerable: 2, text: "Deal {damage} damage. Apply {weak} Weak and {vulnerable} Vulnerable.",
        upgrade: { damage: 20 } },
    bounty_hound: { id: "bounty_hound", pet: "bounty_hound", name: "On the Scent", cost: 1, kind: "attack", target: "foe", tier: 3,
        damage: 9, draw: 2, text: "Deal {damage} damage. Draw 2 cards.",
        upgrade: { damage: 12 } },
    elephant_spear: { id: "elephant_spear", pet: "elephant_spear", name: "Guard Detail", cost: 2, kind: "skill", target: "self", tier: 3,
        block: 14, thorns: 5, text: "Gain {block} Block. Deal {thorns} damage back to anything that hits you.",
        upgrade: { block: 19, thorns: 7 } },
    gilded_magpie: { id: "gilded_magpie", pet: "gilded_magpie", name: "Never the Smaller", cost: 0, kind: "skill", target: "self", tier: 3,
        energy: 2, draw: 1, exhaust: true, text: "Gain {energy} energy and draw {draw} card{s:draw}. Exhaust.",
        upgrade: { draw: 2 } },
    croupiers_cat: { id: "croupiers_cat", pet: "croupiers_cat", name: "House Edge", cost: 1, kind: "skill", target: "foe", tier: 3,
        foeStrength: 1, weak: 2, text: "The enemy loses {foeStrength} Strength for good. Apply {weak} Weak.",
        upgrade: { foeStrength: 2, weak: 3 } },
    velvet_lynx: { id: "velvet_lynx", pet: "velvet_lynx", name: "Unasked", cost: 1, kind: "attack", target: "foe", tier: 3,
        damage: 12, exhaust: true, text: "Deal {damage} damage. Exhaust.",
        upgrade: { damage: 16 } },
    deep_angler: { id: "deep_angler", pet: "deep_angler", name: "The Lure", cost: 2, kind: "attack", target: "foe", tier: 3,
        damage: 14, heal: 6, text: "Deal {damage} damage. Heal {heal}.",
        upgrade: { damage: 18, heal: 9 } },
    // War Cry already trades a card for Strength; this trades a little guard for it instead.
    ...
    vaultwyrm: { id: "vaultwyrm", pet: "vaultwyrm", name: "The Hoard", cost: 2, kind: "skill", target: "self", tier: 3,
        ...
        // The sharpened one adds a flat six ON TOP of the pile it counts, and said nothing about it — six
        // Block a card is worth, invisible. The upgrade carries the sentence that mentions it.
        upgrade: { block: 6, text: "Gain Block equal to the cards left in your draw pile, and {block} more." } },
    lodestar: { id: "lodestar", pet: "lodestar", name: "Follow It", cost: 1, kind: "skill", target: "self", tier: 3,
        drawTo: 7, exhaust: true, text: "Draw until you are holding {drawTo} cards. Exhaust.",
        upgrade: { drawTo: 9 } },
    ...
    ammonite: { id: "ammonite", pet: "ammonite", name: "Long Memory", cost: 1, kind: "skill", target: "self", tier: 3,
        recall: 1, exhaust: true, text: "Take {recall} card{s:recall} back from your discard pile. Exhaust.",
        upgrade: { recall: 2 } },
    ...
    chameleon: { id: "chameleon", pet: "chameleon", name: "Every Colour", cost: 1, kind: "attack", target: "foe", tier: 3,
        ...
        upgrade: { damage: 11 } },
    runebound_drake: { id: "runebound_drake", pet: "runebound_drake", name: "Runebound", cost: 2, kind: "power", target: "self", tier: 3,
        strengthEach: 1, block: 8, text: "Gain {strengthEach} Strength at the start of every turn. Gain {block} Block.",
        upgrade: { strengthEach: 2 } },
    fairy: { id: "fairy", pet: "fairy", name: "A Wish", cost: 0, kind: "skill", target: "self", tier: 3,
        heal: 8, draw: 1, exhaust: true, text: "Heal {heal}. Draw 1 card. Exhaust.",
        upgrade: { heal: 12 } },
    night_auditor: { id: "night_auditor", pet: "night_auditor", name: "Four in the Morning", cost: 1, kind: "skill", target: "self", tier: 3,
        draw: 3, block: 5, text: "Draw 3 cards. Gain {block} Block.",
        upgrade: { block: 9 } },
    midnight_crane: { id: "midnight_crane", pet: "midnight_crane", name: "Misses Nothing", cost: 1, kind: "skill", target: "foe", tier: 3,
        vulnerable: 3, text: "Apply {vulnerable} Vulnerable.",
        upgrade: { vulnerable: 4 } },
    bandit_shade: { id: "bandit_shade", pet: "bandit_shade", name: "The Raider", cost: 2, kind: "attack", target: "foe", tier: 3,
        damage: 9, hits: 2, weak: 1, text: "Deal {damage} damage twice. Apply {weak} Weak.",
        upgrade: { damage: 12, weak: 2 } },
    tidecaller: { id: "tidecaller", pet: "tidecaller", name: "The Sea Returns", cost: 2, kind: "power", target: "self", tier: 3,
        blockEach: 4, text: "Gain {blockEach} Block at the end of every turn.",
        upgrade: { blockEach: 6 } },
    gourmand_dragon: { id: "gourmand_dragon", pet: "gourmand_dragon", name: "Devour", cost: 2, kind: "attack", target: "foe", tier: 3,
        damage: 16, heal: 10, exhaust: true, text: "Deal {damage} damage. Heal {heal}. Exhaust.",
        upgrade: { damage: 21, heal: 14 } },
    road_cur: { id: "road_cur", pet: "road_cur", name: "Never Left", cost: 0, kind: "attack", target: "foe", tier: 3,
        damage: 3, hits: 2, text: "Deal {damage} damage twice.",
        upgrade: { damage: 5 } },
    deep_golem: { id: "deep_golem", pet: "deep_golem", name: "The Mountain", cost: 2, kind: "skill", target: "self", tier: 3,
        block: 20, thorns: 6, text: "Gain {block} Block. Deal {thorns} damage back to anything that hits you.",
        upgrade: { block: 26, thorns: 8 } },
    bosun_shade: { id: "bosun_shade", pet: "bosun_shade", name: "The Bosun", cost: 1, kind: "power", target: "self", tier: 3,
        energyEach: 1, selfHp: 3, text: "Lose {selfHp} health. Gain 1 energy every turn.",
        upgrade: { selfHp: 1 } },
    goblin_warchief: { id: "goblin_warchief", pet: "goblin_warchief", name: "Warchief", cost: 2, kind: "skill", target: "self", tier: 3,
        strength: 4, exhaust: true, text: "Gain {strength} Strength. Exhaust.",
        upgrade: { strength: 6 } },
    eternal_wolf: { id: "eternal_wolf", pet: "eternal_wolf", name: "The Long Hunt", cost: 2, kind: "skill", target: "self", tier: 3,
        strengthDouble: true, block: 10, text: "Double your Strength. Gain {block} Block.",
        upgrade: { block: 16 } },
    golem_heart: { id: "golem_heart", pet: "golem_heart", name: "Living Core", cost: 2, kind: "power", target: "self", tier: 3,
        blockKeeps: true, block: 12, text: "Gain {block} Block. Your Block is no longer lost at the start of your turn.",
        upgrade: { block: 18 } },
    gate_moth: { id: "gate_moth", pet: "gate_moth", name: "The Doorward", cost: 1, kind: "attack", target: "foe", tier: 3,
        damage: 6, all: true, vulnerable: 2, exhaust: true, text: "Deal {damage} damage to ALL enemies. Apply {vulnerable} Vulnerable. Exhaust.",
        upgrade: { damage: 9 } },
};
...
export const UNLOCKS = {
    ...
    // collection is that owning a different animal gets you a different thing to do.
