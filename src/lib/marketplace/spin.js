...
const WHEELS = [
    {
        ...
        prizes: [
            ...
            { label: "MINI JACKPOT · 1,500 gold", emoji: "🎰", weight: 3, rare: true, mini: true, tier: "mini", kind: "gold", amount: 1500 },
    ...
    },
    {
        ...
        prizes: [
            ...
            { label: "50% Coupon", emoji: "🏷️", weight: 4, rare: true, tier: "rare", kind: "coupon" },
            { label: "MINI JACKPOT · 6,000 gold", emoji: "🎰", weight: 3, rare: true, mini: true, tier: "mini", kind: "gold", amount: 6000 },
            { label: "Random Pet", emoji: "🐾", weight: 3, rare: true, tier: "rare", kind: "pet" },
            { label: "JACKPOT · 20,000 gold", emoji: "💎", weight: 1, rare: true, jackpot: true, tier: "jackpot", kind: "jackpot", amount: 20000 },
        ],
    },
];
