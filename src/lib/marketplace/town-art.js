...
const ART_PROMPTS = {
    ...
    festival: `A colorful FESTIVAL STAGE — a raised wooden performance stage with striped bunting, hanging paper lanterns and pennant flags, a decorated banner arch overhead, festive and grand. ${BUILDING_STYLE}`,
