...
const ART_PROMPTS = {
    ...
    sky:
        `A bright cheerful DAYTIME BLUE SKY backdrop for a fantasy town — a clear blue sky with EVENLY SCATTERED soft fluffy white cumulus clouds spread UNIFORMLY across the whole width (many small-to-medium clouds, NO single big dominant cloud, NO focal point) so the image tiles AND MIRRORS seamlessly with no obvious repeat or butterfly reflection. Along the VERY BOTTOM edge only, a LOW, SMALL, FAINT, hazy pale-blue silhouette of far-off medieval rooftops and a couple of tiny distant towers, kept small and washed-out so they clearly read as FAR AWAY. CRITICAL: absolutely NO bright white or cream horizon glow, NO haze band, NO fog streak, NO orange — a friendly BLUE daytime sky. Even, generic, repeatable. NO foreground, NO people, NO street, NO large buildings. Painterly 2D video-game background, clean and inviting, no text, no watermark, no border.`,
    cobble:
