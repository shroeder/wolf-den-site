...
// XP CUT ~40% (2026-08-06), and a further 25% (2026-08-09). Over 30 days the raid minted more player XP than any
// other action in the game — 38k across 45 fightersworth, an average of 844 each — while a harvest paid 8 and a
// salvage 10. The first cut brought the average payout to 522, which was still the third-biggest XP source in
// the game off ten payouts a day. The raid should be the best hour you spend, not worth more than a week of
// everything else; the GOLD is untouched at both cuts, because the gold faucet's problem is elsewhere (the farm),
// and the chests are what people actually turn up for.
const RAID_TIERS = [
    { key: "champion", min: 0.25, gold: 1500, xp: 585, chest: "gold", label: "Champion" },
    { key: "veteran", min: 0.12, gold: 1000, xp: 395, chest: "gold", label: "Veteran" },
    { key: "fighter", min: 0.04, gold: 650, xp: 260, chest: "iron", label: "Fighter" },
    { key: "recruit", min: 0, gold: 350, xp: 135, chest: "wooden", label: "Recruit" },
];
