...
export const COLLECTIBLES = [
    ...
    { id: "beaver", name: "Beaver", Icon: GiBeaver, color: "#a97a4a", rarity: "rare", source: "achievement", activeStat: "might", achievement: "Post 3 bounties on the board", spritePrompt: "an industrious beaver with a log" },
    ...
    { id: "copper_paw", name: "Copper Paw", Icon: GiCat, color: "#c98f4a", rarity: "rare", source: "casino",
        casinoExclusive: true, casinoPerk: { freePlay: 0.015 },
    ...
    { id: "tallyman", name: "The Tallyman", Icon: GiRaven, color: "#8794a3", rarity: "epic", source: "casino",
        casinoExclusive: true, casinoPerk: { prizeChance: 0.0075 },
    ...
    { id: "gilded_magpie", name: "Gilded Magpie", Icon: GiRaven, color: "#ffd75e", rarity: "legendary", source: "casino",
        casinoExclusive: true, casinoPerk: { prizeTierUp: true },
    ...
    { id: "croupiers_cat", name: "The Croupier's Cat", Icon: GiCat, color: "#a982ff", rarity: "legendary", source: "casino",
        casinoExclusive: true, casinoPerk: { lossRefund: 0.012 },
        activeStat: "fortune", hint: "Sits on the losing side of the table and disapproves",
        spritePrompt: "an elegant violet-grey cat in a tiny croupier's waistcoat seated beside a keno board, tail curled" },
    { id: "night_auditor", name: "Night Auditor", Icon: GiOwl, color: "#9fc6dd", rarity: "mythic", source: "casino",
        casinoExclusive: true, casinoPerk: { freePlay: 0.02 },
