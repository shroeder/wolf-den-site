...
export const SEEDS = {
    ...
    wheat: { name: "Wheat", emoji: "🌾", sprout: "🌱", growMin: 90, sell: 34, xp: 6, rarity: "common" },
    carrot: { name: "Carrot", emoji: "🥕", sprout: "🌱", growMin: 180, sell: 68, xp: 10, rarity: "common" },
    potato: { name: "Potato", emoji: "🥔", sprout: "🌱", growMin: 240, sell: 100, xp: 14, rarity: "common" },
    // Rare — a few hours; from digs, raids, iron chests.
    strawberry: { name: "Strawberries", emoji: "🍓", sprout: "🌱", growMin: 300, sell: 170, xp: 20, rarity: "rare" },
    corn: { name: "Corn", emoji: "🌽", sprout: "🌱", growMin: 420, sell: 250, xp: 26, rarity: "rare" },
    // Epic — half a day; from raids, gold chests, boss kills.
    grape: { name: "Grapes", emoji: "🍇", sprout: "🌿", growMin: 600, sell: 280, xp: 40, rarity: "epic" },
    pumpkin: { name: "Pumpkin", emoji: "🎃", sprout: "🌿", growMin: 900, sell: 430, xp: 62, rarity: "epic" },
    // Legendary — overnight; from gold chests + boss kills only.
    goldenapple: { name: "Golden Apple", emoji: "🍎", sprout: "✨", growMin: 1440, sell: 690, xp: 130, rarity: "legendary" },
    // Mythic — a day and a half; the jackpot, only from the very best sources.
    starfruit: { name: "Star Fruit", emoji: "⭐", sprout: "✨", growMin: 2160, sell: 1440, xp: 300, rarity: "mythic" },
};
