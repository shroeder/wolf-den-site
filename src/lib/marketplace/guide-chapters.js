...
export const GUIDE_CHAPTERS = [
    {
        ...
        steps: [
            { key: "hero_look", label: "Open your hero", why: "Everything you earn lands here. Your level, your gold and the eight gear slots you'll spend the rest of the game filling.", href: "/marketplace/inventory", cta: "Open my gear", gold: 75, events: ["view_inventory", "view_profile", "inspect_item"] },
            { key: "hero_equip", label: "Equip a piece of gear", why: "Gear is the whole progression. Every stat on what you're wearing feeds your boss damage, your luck and how deep you can go underground.", href: "/marketplace/inventory", cta: "Go and equip", gold: 100, events: ["equip"] },
            { key: "hero_face", label: "Make the hero look like you", why: "Your hero is drawn once and follows you everywhere — the town plaza, the leaderboards, the chat. Worth a minute.", href: "/marketplace/customize", cta: "Customize", gold: 100, verify: "avatar" },
        ],
        reward: { gold: 150, chest: "wooden" },
    },
    {
        ...
        steps: [
            { key: "farm_plant", label: "Plant your first crop", why: "Crops grow on a real clock whether the tab is open or not. This is the one system that pays you for coming back tomorrow.", href: "/marketplace/farm", cta: "Go to the farm", gold: 100, events: ["plant_seed"] },
            { key: "farm_fert", label: "Fertilize something", why: "Fertilizer cuts the wait and improves what you pull out. You'll always have more seeds than fertilizer, so spend it on the slow stuff.", href: "/marketplace/farm", cta: "Fertilize a crop", gold: 100, events: ["fertilize_crop"] },
            { key: "farm_harvest", label: "Bring in a harvest", why: "Harvests pay gold and ingredients. The ingredients are what the kitchen turns into buffs — that's chapter seven.", href: "/marketplace/farm", cta: "Harvest", gold: 125, events: ["harvest_crop"] },
        ],
        reward: { gold: 200, chest: "wooden" },
    },
    {
        ...
        steps: [
            { key: "chest_open", label: "Open a chest", why: "Chests drop gear, gold and the occasional pet. They come from quests, the wheel, the boss and the sea — you will never be short of them for long.", href: "/marketplace/inventory", cta: "Open one", gold: 100, events: ["open_chest"] },
            { key: "chest_spin", label: "Spin the daily wheel", why: "One free spin a day, twenty wedges, a jackpot that grows every time anyone in the Den spins it. It costs nothing to take.", href: "/marketplace/spin", cta: "Spin", gold: 100, events: ["daily_spin"] },
            { key: "chest_checkin", label: "Check in for the day", why: "A streak pays more the longer you hold it, and it resets if you miss a day. Thirty seconds, every day, forever.", href: "/marketplace/play", cta: "Check in", gold: 100, events: ["daily_checkin"] },
        ],
        reward: { gold: 200, chest: "iron" },
    },
    {
        ...
        steps: [
            { key: "pet_equip", label: "Equip a pet", why: "An equipped pet adds its passive to everything you do and levels up alongside you. Only one at a time, so pick for what you actually play.", href: "/marketplace/pets", cta: "Equip a pet", gold: 100, events: ["equip_pet"] },
            { key: "pet_feed", label: "Feed it a treat", why: "Treats are pet XP. Each level scales the pet's passive, up to five times its starting value — a maxed pet is a real stat line.", href: "/marketplace/farm", cta: "Feed it", gold: 100, events: ["feed_pet"] },
        ],
        reward: { gold: 175, chest: "iron" },
    },
    {
        ...
        steps: [
            { key: "boss_look", label: "Go and look at the boss", why: "Everyone fights the same boss. Its weakness changes each week, and gear matching that element hits far harder.", href: "/marketplace/boss", cta: "See the boss", gold: 75, events: ["view_boss"] },
            { key: "boss_hit", label: "Land a strike", why: "You get a handful of strikes a day. Damage earns raffle tickets toward the prize when the boss falls, so showing up matters more than hitting hard.", href: "/marketplace/boss", cta: "Strike it", gold: 125, events: ["boss_attack"] },
            { key: "boss_cheer", label: "Cheer another member", why: "Three cheers a day. It buffs their next hit and pays you XP and gold for doing it — the Den does more damage when people use them.", href: "/marketplace/boss", cta: "Cheer someone", gold: 100, events: ["cheer"] },
        ],
        reward: { gold: 250, chest: "iron" },
    },
    {
        id: "town", name: "The Town", minLevel: 3, tint: "#8fd8ff", icon: "/images/guide/ch-town.webp",
        blurb: "Where the other members actually are.",
        steps: [
            { key: "town_pet", label: "Pet somebody else's animal", why: "Everyone's hero and pets stand in the plaza. Petting one pays you both, and it's the fastest way to meet the rest of the Den.", href: "/marketplace/town", cta: "Go to town", gold: 100, events: ["pet_other"] },
            { key: "town_rate", label: "Rate a farm", why: "Three ratings a day, one per person. Farms rank against each other on the total, so a visit is worth something to whoever built it.", href: "/marketplace/town", cta: "Visit a farm", gold: 100, events: ["farm_rate"] },
            { key: "town_quest", label: "Finish a town quest", why: "You don't sign up for these. The Quartermaster posts five a day — the same five for everyone — and they're jobs you were going to do anyway. Do one, then collect the gold off him.", href: "/marketplace/town", cta: "See the board", gold: 100, events: ["town_quest"] },
        ],
        reward: { gold: 250, chest: "iron" },
    },
    {
        ...
        steps: [
            { key: "sea_fish", label: "Land a fish", why: "Casting is free and quick. Fish pay gold, and the rare ones are worth putting on your profile.", href: "/marketplace/fishing", cta: "Go fishing", gold: 100, events: ["fish_caught"] },
            { key: "sea_sail", label: "Send the boat out", why: "A voyage runs for hours in the background and comes back loaded. Start one before you close the tab and it works while you don't.", href: "/marketplace/sailing", cta: "Set sail", gold: 125, events: ["sail_voyage"] },
            { key: "sea_dig", label: "Dig for treasure", why: "There is a real treasure chest buried in the sand. Uncover every tile of it and the chest is yours, at whatever tier was down there — this is the only place chests come from.", href: "/marketplace/sailing", cta: "Dig", gold: 125, events: ["sail_dig"] },
        ],
        reward: { gold: 300, chest: "gold" },
    },
    {
        ...
        steps: [
            { key: "kitchen_recipe", label: "Learn a recipe", why: "Recipes drop from the wheel, chests and the town. Each one unlocks a dish with its own buff.", href: "/marketplace/cooking", cta: "Open the kitchen", gold: 100, events: ["recipe_learned"] },
            { key: "kitchen_cook", label: "Cook something", why: "Cooking is a timing minigame — hit the band and the dish comes out better. Eat it before a boss night.", href: "/marketplace/cooking", cta: "Cook", gold: 125, events: ["cooked"] },
        ],
        reward: { gold: 225, chest: "iron" },
    },
    {
        ...
        steps: [
            { key: "shelf_compendium", label: "Open the compendium", why: "Every item you have ever held is recorded here permanently — including the ones you sold, salvaged or traded away. Cross ten and it starts paying real stats into every fight you take, and it keeps paying at twenty-five, fifty and a hundred.", href: "/marketplace/compendium", cta: "See the compendium", gold: 100, events: ["view_compendium"] },
            { key: "shelf_sets", label: "Find a set you're close to", why: "Gear sets pay when you WEAR the pieces together. Collections are the opposite — trophies pay for being owned and you never equip them at all, so a collection you finished two months ago is still working right now.", href: "/marketplace/sets", cta: "Check my sets", gold: 125, events: ["view_sets"] },
        ],
        reward: { gold: 225, chest: "iron" },
    },
    {
        ...
        steps: [
            { key: "forge_salvage", label: "Salvage a spare piece", why: "Duplicate gear is raw material. Salvaging breaks it into tiered parts and costs you nothing you were using.", href: "/marketplace/blacksmith", cta: "Open the forge", gold: 100, events: ["craft_salvage", "sell_gear"] },
            { key: "forge_enhance", label: "Enhance a piece you wear", why: "Parts hammer straight into a piece's stats, and a lucky strike rolls a bonus affix on top. This is how a favourite item keeps up.", href: "/marketplace/blacksmith", cta: "Enhance something", gold: 150, events: ["craft_enhance"] },
        ],
        reward: { gold: 300, chest: "gold" },
    },
    {
        ...
        steps: [
            { key: "deco_place", label: "Place a decoration", why: "A hundred of them, and the good ones carry real buffs. Where you put things is up to you — people come and look.", href: "/marketplace/farm", cta: "Decorate", gold: 100, events: ["place_deco", "arrange_deco"] },
    ...
    },
    {
        ...
        steps: [
            { key: "mine_trip", label: "Take a trip down", why: "Every level down pays better ore and raises the chance the roof comes in. You choose when to surface — that's the whole game.", href: "/marketplace/mining", cta: "Go down", gold: 125, events: ["mine_trip", "ore_mined"] },
            { key: "mine_smelt", label: "Smelt your ore", why: "Raw ore is worth little; smelted, it becomes the parts the forge runs on. The smelter is its own timing game.", href: "/marketplace/mining", cta: "Smelt", gold: 150, events: ["ore_smelted"] },
        ],
    ...
    },
    {
        ...
        steps: [
            { key: "delve_run", label: "Walk into a dungeon", why: "Ten floors, one encounter each, and a boss at the bottom. Your health and your swing come off your level and the gear you are wearing, so this is the first place a good loadout really shows.", href: "/marketplace/dungeons", cta: "Descend", gold: 125, events: ["delve_start"] },
            { key: "delve_boss", label: "Fell a dungeon boss", why: "Reach floor ten and the thing waiting there pays a purse, a chest and parts on top of everything you carried down. Die on the way and you still keep the lot — there is no way to lose what you already banked.", href: "/marketplace/dungeons", cta: "Go and kill it", gold: 200, events: ["delve_clear"] },
        ],
        reward: { gold: 350, chest: "gold" },
    },
    {
    ...
    },
    {
        ...
        steps: [
            ...
            { key: "casino_table", label: "Sit at a table", why: "Blackjack, keno and bingo are away from the reels and they pay exactly the multiple printed on the felt — three-to-two is three-to-two, and five of five on a ticket is five of five. Nothing here is quietly worth less than it says.", href: "/marketplace/casino", cta: "Take a seat", gold: 175, verify: "casinotable" },
    ...
    },
    {
        ...
        steps: [
            { key: "trade_open", label: "Offer somebody a trade", why: "Gear and pets both move. You'll end up with duplicates of things somebody else needs, and vice versa.", href: "/marketplace/trade", cta: "Open trading", gold: 125, events: ["trade_propose", "trade_accept"] },
        ],
        reward: { gold: 250, chest: "gold" },
    },
    {
        ...
        steps: [
            { key: "store_notify", label: "Turn on notifications", why: "Boss fights, trade offers and restock alerts. It's the only way to hear about a raid before it's over — and the Den only raids for a few hours.", href: "/marketplace/notifications", cta: "Turn them on", gold: 125, verify: "push" },
            { key: "store_wishlist", label: "Tell us what you're hunting", why: "Add a card to Looking For and we message you when one lands in the case. It costs nothing and it works.", href: "/looking-for", cta: "Add a card", gold: 125, verify: "wishlist" },
