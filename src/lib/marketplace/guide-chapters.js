...
export const GUIDE_CHAPTERS = [
    {
        ...
        steps: [
            { key: "hero_look", label: "Open your hero", why: "Everything you earn lands here. Your level, your gold and the eight gear slots you'll spend the rest of the game filling.", href: "/marketplace/profile", cta: "Open my profile", gold: 150, events: ["view_inventory", "view_profile", "inspect_item"] },
            { key: "hero_equip", label: "Equip a piece of gear", why: "Gear is the whole progression. Every stat on what you're wearing feeds your boss damage, your luck and how deep you can go underground.", href: "/marketplace/profile", cta: "Go and equip", gold: 200, events: ["equip"] },
    ...
    },
    {
        ...
        steps: [
            { key: "chest_open", label: "Open a chest", why: "Chests drop gear, gold and the occasional pet. They come from quests, the wheel, the boss and the sea — you will never be short of them for long.", href: "/marketplace/rewards", cta: "Open one", gold: 200, events: ["open_chest"] },
    ...
    },
    {
        ...
        steps: [
            { key: "pet_equip", label: "Equip a pet", why: "An equipped pet adds its passive to everything you do and levels up alongside you. Only one at a time, so pick for what you actually play.", href: "/marketplace/profile", cta: "Equip a pet", gold: 200, events: ["equip_pet"] },
            { key: "pet_feed", label: "Feed it a treat", why: "Treats are pet XP. Each level scales the pet's passive, up to five times its starting value — a maxed pet is a real stat line.", href: "/marketplace/profile", cta: "Feed it", gold: 200, events: ["feed_pet"] },
        ],
    ...
    },
    {
        ...
        steps: [
            { key: "boss_look", label: "Go and look at the boss", why: "Everyone fights the same boss. Its weakness changes each week, and gear matching that element hits far harder.", href: "/marketplace/play", cta: "See the boss", gold: 150, events: ["view_boss"] },
            { key: "boss_hit", label: "Land a strike", why: "You get a handful of strikes a day. Damage earns raffle tickets toward the prize when the boss falls, so showing up matters more than hitting hard.", href: "/marketplace/play", cta: "Strike it", gold: 250, events: ["boss_attack"] },
            { key: "boss_cheer", label: "Cheer another member", why: "Three cheers a day. It buffs their next hit and pays you XP and gold for doing it — the Den does more damage when people use them.", href: "/marketplace/play", cta: "Cheer someone", gold: 200, events: ["cheer"] },
        ],
    ...
    },
    {
        ...
        steps: [
            ...
            { key: "town_rate", label: "Rate a farm", why: "Three ratings a day, one per person. Farms rank against each other on the total, so a visit is worth something to whoever built it.", href: "/marketplace/farm", cta: "Visit a farm", gold: 200, events: ["farm_rate"] },
            { key: "town_quest", label: "Take a town quest", why: "The Quartermaster posts five a day, the same five for everyone. They're small jobs you were going to do anyway, paid.", href: "/marketplace/town", cta: "See the quests", gold: 200, events: ["town_merchant", "tavern_barkeep", "stockade_act", "buy_upgrade"] },
        ],
        reward: { gold: 500, chest: "iron" },
    },
    {
    ...
    },
    {
        ...
        steps: [
            { key: "forge_salvage", label: "Salvage a spare piece", why: "Duplicate gear is raw material. Salvaging breaks it into tiered parts and costs you nothing you were using.", href: "/marketplace/forge", cta: "Open the forge", gold: 200, events: ["craft_salvage", "sell_gear"] },
            { key: "forge_enhance", label: "Enhance a piece you wear", why: "Parts hammer straight into a piece's stats, and a lucky strike rolls a bonus affix on top. This is how a favourite item keeps up.", href: "/marketplace/forge", cta: "Enhance something", gold: 300, events: ["craft_enhance"] },
        ],
        reward: { gold: 600, chest: "gold" },
    },
    {
