...
export async function cookRecipe(buyerId, recipeId, { quality = null, chain = 0 } = {}) {
    ...
    if (rec.kind === "bait") {
        ...
        // The dish is now a consumable you own, and feeding it to your equipped pet is what it is for (see
        // DISH_PET_XP in consumables.js for the tier numbers and how they were sized). This is IN ADDITION to
        // the ladder rung above — nothing that used to pay out stopped paying.
        //
