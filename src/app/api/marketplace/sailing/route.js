...
import { getSailingState, startVoyage, collectVoyage, upgradeSpeed, upgradeLuck } from "@/lib/marketplace/sailing.js";
    ...
    return withRequestLogging(request, "POST /api/marketplace/sailing", async ({ internalError }) => {
        try {
            ...
            switch (body?.action) {
                ...
                case "collect": return noStore(await collectVoyage(g.buyer.id));
