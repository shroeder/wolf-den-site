...
const FAQS = [
    ...
    { q: "What are your hours?", a: `${hoursSummary({ short: false })}. ${closedSummary({ short: false })}.` },
            ...
            <section className="card" id="visit">
                ...
                <div className="grid two-col about-visit">
                    <div>
                        ...
                        <p><strong>Hours</strong><br />{hoursSummary()}<br /><span className="muted">{closedSummary()}</span></p>
                    </div>
                    <div>
