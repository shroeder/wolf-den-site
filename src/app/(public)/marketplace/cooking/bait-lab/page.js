...
import BaitLab from "@/components/BaitLab";
import { getKitchenState, cookingSprites } from "@/lib/marketplace/cooking.js";
import { BAITS } from "@/lib/marketplace/cooking.js";
...
export const metadata = { title: "Bait Lab", robots: { index: false, follow: false } };
...
export default async function BaitLabPage() {
    ...
    return <BaitLab kitchen={kitchen} baits={baits} sprites={sprites} />;
}
