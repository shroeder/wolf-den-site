// Battle sprites for the four fishing-exclusive pets — the BASE sprite plus all four evolved forms (Lv2-5),
...
const PETS = {
    reef_seahorse: "a small curled seahorse in bright coral pink and cyan, delicate fins fluttering",
    lantern_jelly: "a translucent violet jellyfish glowing softly from within, long trailing luminous tendrils",
    deep_angler: "a small deep-sea anglerfish companion with an oversized toothy grin and a bright glowing lure bobbing above its head",
    tidecaller: "a small serene whale calf wreathed in swirling turquoise water and glowing runes, trailing sea-foam",
};
