// Battle sprites for the five KITCHEN pets — the BASE sprite plus all four evolved forms (Lv2-5),
...
// Kept in step with the `source: "achievement" kitchen` entries in collectibles.js.
const PETS = {
    pantry_mouse: "a tiny round grey field mouse in a little cook's apron clutching a single wheat grain, whiskers twitching, bright curious eyes",
    copper_kettle: "a small living copper kettle creature with stubby legs and a cheerful spout face, steam curling from its lid, polished dented copper",
    hearth_cat: "a plump ginger cat curled up content, its fur glowing faintly like banked embers, warm orange light coming off its belly",
    spice_moth: "a large velvety moth with wings patterned like ground spices in saffron, paprika and violet, trailing a fine shimmer of powder",
    gourmand_dragon: "a small round gold dragon with an enormous well-fed belly, a napkin tucked under its chin, holding a tiny silver fork, extremely pleased with itself",
};
